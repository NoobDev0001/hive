...
{
    const char* pszTimestamp = "The Times 03/30/2021 NASA wil be financially unstable";
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0"); // Block 336450

        // By default assume that the signatures in ancestors of this block are valid. Block# 
        consensus.defaultAssumeValid = uint256S("0x0"); // Block 336450
		...
		uint32_t nGenesisTime = 1664726731;		//1613692800;  // 2021-02-19 08:00:00
